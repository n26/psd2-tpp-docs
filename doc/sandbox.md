...
### Emails and use cases for SEPA credit transfers
...
### Emails and use cases for Instant SEPA credit transfers
| User email                                       | Use case description                                                               | Payment Status/Time           | Payment Status/Time after previous status | Payment Status/Time after previous status | Payment Status/Time after previous status |
|--------------------------------------------------------|-----------------------------------------------------------------------------------|-------------------------------|-------------------------------------------|-------------------------------------------|-------------------------------------------|
| openbankingpsu-instant@n26.com                       | Payment is successful                                                              | RCVD / After creating payment | ACCP / 2 seconds                          | ACFC / 2 seconds                          | ACCC / 2 seconds                          |
| test.account+account-selection-success-instant@n26.com | Payment is successful after customer selects account to initiate the payment from | RCVD / After creating payment | ACCP / 5 seconds                          | ACFC / 5 seconds                          | ACCC / 5 seconds                          |

### Emails and use cases for SEPA and Instant SEPA credit transfer failures
| User email                                      | Use case description                                                            | Payment Status/Time           | Payment Status/Time after previous status | Payment Status/Time after previous status | Payment Status/Time after previous status |
|------------------------------------------------|--------------------------------------------------------------------------------|-------------------------------|-------------------------------------------|-------------------------------------------|-------------------------------------------|
