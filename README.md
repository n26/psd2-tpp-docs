...
- **September 18, 2025** Additional transaction status ACCC will replace ACSC in the /v1/payments/instant-sepa-credit-transfers/{{paymentId}}/status endpoint, from Oct 9th 2025, to comply with the Instant Payments Regulation enforced by the European Union.
